...
const InfoPointsStudants = ({ aluno, onClose }) => {
  ...
  const fetchPontos = async () => {
    ...
    try {
      const response = await axios.get(`https://escolinha.paranoa.com.br/APIEscolinha2/alunos/${aluno.id}/pontos`, {
  ...
  const handleExcluirPonto = async (pontoId) => {
    ...
    try {
      await axios.delete(`https://escolinha.paranoa.com.br/APIEscolinha2/professores/ponto/${pontoId}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      fetchPontos(); 
