    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                `https://escolinha.paranoa.com.br/APIEscolinha2/professores/falta-justificada/${formData.alunoId}`,
                {
                    data: dia,
    ...
    const handleDeletarFalta = async (faltaId) => {
        ...
        try {
            const response = await axios.delete(
                `https://escolinha.paranoa.com.br/APIEscolinha2/professores/falta/${faltaId}`,
                {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                    },
